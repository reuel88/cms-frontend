...
const navigation = {
  products: [
    { name: "Invest", href: "#" },
    { name: "Raiz Super", href: "#" },
    { name: "SMSF", href: "#" },
    { name: "Raiz Rewards", href: "#" },
    { name: "Raiz Kids", href: "#" },
    { name: "Raiz Property Fund", href: "#" },
    { name: "Offsetters", href: "#" },
  ],
  support: [
    { name: "FAQ and Help", href: "#" },
  ...
  legal: [
    ...
    { name: "PDS", href: "/product-disclosure-statement" },
    { name: "Super PDS", href: "/" },
    { name: "TMD", href: "/" },
    { name: "Super TMD", href: "/" },
    { name: "Disclosures", href: "/disclosures" },
    { name: "Important Documents", href: "/important-documents" },
...
const SiteFooter: FC = () => {
  return (
    ...
    >
      ...
      <div className="prose mt-16 max-w-none space-y-4 border-t border-gray-900/10 pt-8 text-xs sm:mt-20 lg:mt-24">
        <p>
          ...
          AFSL 434776) a subsidiary of Raiz Invest Limited and promoted by Raiz
          Invest Australia Limited (ACN 604 402 815). Product Disclosure
          ...
          not, to acquire and continue to hold interests in these products. The
          risks of investing in these products are fully set out in the PDS and
        ...
        <p>
          ...
          are issued by Equity Trustees Superannuation Limited (AFSL 229757, RSE
          Licence No L0001458) as Trustee of AMG Super. A person should consider
          the information in the PDS and the other important information
          (including the Members Guide) which form part of the PDS. The Raiz
          Invest Super PDS contains all information on our super investment
          options and fees.
        </p>
        ...
        <p>
          Raiz Home Ownership Pty Ltd (ABN 14 645 876 937), an Australian Credit
          Representative number 528594 under Australian Credit Licence number
          387025. Raiz Home Ownership Pty Ltd is 100% owned by Raiz Invest
          Australia Limited (ABN 26 604 402 815).
        </p>

        <p>
          {'"Raiz"'} are registered trademarks of Raiz Invest Limited. ©2022
          Raiz Invest Limited
        </p>
