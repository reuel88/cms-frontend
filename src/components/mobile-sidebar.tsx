            ...
            <div className="space-y-2 py-6">
              <Accordion type="single" collapsible className="-mx-3">
                <AccordionItem value="Product" className="border-none">
                  <AccordionTrigger className="hover:underline- flex w-full items-center justify-between rounded-lg py-2 pl-3 pr-3.5 text-base font-semibold leading-7 text-gray-900 hover:bg-gray-50">
                    Product
                  </AccordionTrigger>
                  <AccordionContent>
                    <a
