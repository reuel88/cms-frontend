        ...
        <div className="mx-auto grid max-w-2xl grid-cols-1 gap-x-8 gap-y-8 lg:mx-0 lg:max-w-none lg:grid-flow-col lg:grid-cols-3 lg:grid-rows-[1fr_minmax(0,100%)]">
          <SiteAside>
            <SiteAsideContainer>
              <nav className="flex" aria-label="Breadcrumb">
                <ol
                  role="list"
                  className="flex flex-wrap items-center gap-y-4 space-x-4"
                >
                  <li>
                    <div>
                      <a
          ...
          <section className="col-span-1 space-y-16 lg:col-span-2 lg:col-start-2 lg:row-span-2">
            <div className="prose">
              ...
              <h2>From beginner to expert in 3 hours</h2>
              <p>
            ...
            <div className="prose prose-sm">
              <p>
                <strong>Important Information:</strong> The information on this
                website is general advice only. This means it does not take into
                account any person’s particular investment objectives, financial
                situation or investment needs. If you are an investor, you
                should consult your licensed adviser before acting on any
                information contained in this article to fully understand the
                benefits and risk associated with the product.
              </p>
              <p>
